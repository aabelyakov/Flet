        ...
        Column([
                ...
                Card(
                    ...
                    content=Container(
                        ...
                        content=Column([
                            ...
                            Row([
                                Text("Cleanup Sugested", color="#87888A", size=10)],
                                alignment="center")
                        ], alignment="center")
                        # END CONTAINER
                    )
            ...
            Row([
                ...
                Container(
                    content=Row([
                        ...
                        Text("Deleted 31 Gb", size=15, color="black", weight="bold")
                    ], alignment="center")
                ),
            ...
            Column([
                Container(
                    ...
                    bgcolor="black",
                    border_radius=border_radius.only(topRight=30, bottomRight=30),
                    content=Text("can be Deleted", size=20, weight="bold",
                                 color="white"
                                 )
                ),
                # STACK CARD
                Stack([
                    ...
                    Row([
                        Card(
                            ...
                            content=Container(
                                margin=margin.symmetric(vertical=-30),
                                border_radius=border_radius.only(bottomLeft=30, topRight=30),
                                padding=10,
                                bgcolor="green",
                                content=Row([
                                    Icon(icons.FAVORITE, color=colors.PINK),
                                    Text("Health System", size=20, weight="bold",
                                         color="white"
                                         )
                                ])
                            )
